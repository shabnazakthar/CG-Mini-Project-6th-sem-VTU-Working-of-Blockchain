...
int i;
char *str1 = "P.A. COLLEGE OF ENGINEERING, MANGALORE";
...
char *str8 = "SHABNAZ (4PA20CS102)";
char *str9 = "(4PA20CS102)";
char *str12 = "RIFAH SAMEEN I SARANG (4PA20CS097)";
//char *str12 = "(4PA20CS097)";
char *str10 = "GUIDE:";
char *str11 = "PROF. Dr.HAYAN";
...
void display1()
{
	...
	//for (i = 0;i<strlen(str68);i++)
		//glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str68[i]); //NIKHIL AMIN
	//glRasterPos2f(6,-6);
	for (i = 0;i<strlen(str12);i++)
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str12[i]); //(4PA15CS073)
	glRasterPos2f(7, -7);
	for (i = 0;i<strlen(str11);i++)
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str11[i]); //GUIDES:
	glRasterPos2f(5.5, -6);
	for (i = 0;i<strlen(str10);i++)
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str10[i]); //PROF. NAMRATHA RAI
	glRasterPos2f(-5, 6);
	//for (i = 0;i<strlen(str12);i++)
